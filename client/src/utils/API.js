...
const key = "5a3f3373b8ebcad2db18450af15ec4fd";

const searchCall = function (search) {
    var queryURL = "https://api.themoviedb.org/3/search/movie?api_key="+key+"&language=en-US&query=" + search + "&page=1&include_adult=false";
    return (axios.get(queryURL));
}
const idCall = function (id) {
    var queryURL = "https://api.themoviedb.org/3/movie/" + id + "?api_key="+key+"&language=en-US&append_to_response=credits,external_ids"
    return (axios.get(queryURL));
}
